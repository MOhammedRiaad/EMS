...
export class SyncMissingTables1769681843728 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."announcements_targettype_enum" AS ENUM('all', 'clients', 'coaches', 'specific_users')`);
        ...
        await queryRunner.query(`CREATE TABLE "announcement_reads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "announcementId" uuid NOT NULL, "userId" uuid NOT NULL, "readAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d82327e564612085a67f912bfae" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."automation_executions_status_enum" AS ENUM('pending', 'completed', 'failed', 'cancelled')`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "notification_preferences" jsonb`);
        await queryRunner.query(`ALTER TABLE "automation_rules" ADD "actions" jsonb`);
        await queryRunner.query(`ALTER TABLE "automation_rules" ALTER COLUMN "actionType" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "automation_rules" ALTER COLUMN "actionPayload" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "announcement_reads" ADD CONSTRAINT "FK_77c99446ffea2d8edb5b751e6aa" FOREIGN KEY ("announcementId") REFERENCES "announcements"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "announcement_reads" ADD CONSTRAINT "FK_3451abd01aa042855d22b13bcad" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "automation_executions" ADD CONSTRAINT "FK_6c64863efb57532f36d31d1bd4b" FOREIGN KEY ("ruleId") REFERENCES "automation_rules"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "automation_executions" DROP CONSTRAINT "FK_6c64863efb57532f36d31d1bd4b"`);
        await queryRunner.query(`ALTER TABLE "announcement_reads" DROP CONSTRAINT "FK_3451abd01aa042855d22b13bcad"`);
        await queryRunner.query(`ALTER TABLE "announcement_reads" DROP CONSTRAINT "FK_77c99446ffea2d8edb5b751e6aa"`);
        await queryRunner.query(`ALTER TABLE "automation_rules" ALTER COLUMN "actionPayload" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "automation_rules" ALTER COLUMN "actionType" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "automation_rules" DROP COLUMN "actions"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."announcements_targettype_enum"`);
