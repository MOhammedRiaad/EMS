...
export class UpdateAutomationEnums1770100000011 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."automation_rules_triggertype_enum" ADD VALUE 'session_reminder'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."automation_rules_actiontype_enum" ADD VALUE 'send_whatsapp'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."automation_rules_actiontype_enum" ADD VALUE 'send_notification'`,
    );
  }
