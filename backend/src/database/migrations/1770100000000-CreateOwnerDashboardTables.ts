...
export class CreateOwnerDashboardTables1770100000000 implements MigrationInterface {
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_permissions_category ON permissions(category);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_permissions_key ON permissions(key);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_roles_key ON roles(key);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_roles_tenant ON roles(tenant_id);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_feature_flags_key ON feature_flags(key);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_feature_flags_category ON feature_flags(category);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_feature_assignments_tenant ON feature_assignments(tenant_id);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_feature_assignments_feature ON feature_assignments(feature_key);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_plans_key ON plans(key);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_usage_metrics_tenant ON usage_metrics(tenant_id);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_usage_metrics_type ON usage_metrics(metric_type);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_usage_metrics_date ON usage_metrics(date);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_usage_metrics_composite ON usage_metrics(tenant_id, metric_type, date);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_owner_audit_logs_owner ON owner_audit_logs(owner_id);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_owner_audit_logs_action ON owner_audit_logs(action);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_owner_audit_logs_tenant ON owner_audit_logs(target_tenant_id);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_owner_audit_logs_created ON owner_audit_logs(created_at);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_plan_upgrade_requests_tenant ON plan_upgrade_requests(tenant_id);`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_plan_upgrade_requests_status ON plan_upgrade_requests(status);`);
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_tenants_is_blocked ON tenants(is_blocked);`);
    }
