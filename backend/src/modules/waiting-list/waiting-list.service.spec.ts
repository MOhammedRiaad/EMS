...
describe('WaitingListService', () => {
    ...
    describe('findAll', () => {
        ...
        it('should filter by status when provided', async () => {
            ...
            await service.findAll('tenant-123', { status: WaitingListStatus.PENDING });
    ...
    describe('remove', () => {
        ...
        it('should throw NotFoundException if entry not found', async () => {
            ...
            await expect(
                service.remove('nonexistent', 'tenant-123')
            ).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('approve', () => {
        it('should approve entry and set approver info', async () => {
            ...
            const result = await service.approve('entry-123', 'approver-123', 'tenant-123');
    ...
    describe('updatePriority', () => {
        it('should update entry priority', async () => {
            ...
            const result = await service.updatePriority('entry-123', 500, 'tenant-123');
    ...
    describe('notifyClient', () => {
        ...
        it('should send notification email and update status', async () => {
            ...
            const result = await service.notifyClient('entry-123', 'tenant-123', mockMailerService);
        ...
        it('should throw error if client has no email', async () => {
            const entryNoEmail = { ...mockEntry, client: { ...mockEntry.client, email: null } };
