...
describe('WaiversService', () => {
    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: getRepositoryToken(ClientWaiver), useValue: mockClientWaiverRepo },
    ...
    describe('getLatestWaiver', () => {
        it('should return existing active waiver', async () => {
            const waiver = { id: 'w1', version: '1.0', content: 'test', isActive: true };
        ...
        it('should create default waiver if none exists', async () => {
            ...
            const newWaiver = { id: 'w-new', version: '1.0', content: 'default', isActive: true };
    ...
    describe('signWaiver', () => {
        it('should create signature record', async () => {
            const userId = 'u1';
            const dto = { waiverId: 'w1', signatureData: 'data:image/png;base64,...' };
            const client = { id: 'c1' };
            const waiver = { id: 'w1' };
            ...
            const result = await service.signWaiver('tenant-1', userId, dto, '1.2.3.4', 'Mozilla/5.0');
        ...
        it('should throw if already signed', async () => {
            ...
            await expect(service.signWaiver('tenant-1', userId, dto, 'ip', 'ua'))
