...
export class UpgradeRequestController {
  ...
  async rejectRequest(
    ...
    return this.upgradeRequestService.rejectRequest(
      requestId,
      req.user.id,
      notes,
    );
...
export class TenantUpgradeRequestController {
  ...
  async submitRequest(
    ...
    return this.upgradeRequestService.submitUpgradeRequest(
      tenantId,
      userId,
      requestedPlan,
      reason,
  ...
  async getRequestHistory(@Request() req: any) {
    return this.upgradeRequestService.getTenantRequestHistory(
      req.user.tenantId,
    );
  }
  ...
  async cancelRequest(
    ...
    await this.upgradeRequestService.cancelRequest(
      requestId,
      req.user.tenantId,
    );
