...
import { BroadcastService, SystemConfigService, FeatureFlagService, OwnerDataExportService } from '../services';
...
export class OwnerController {
    ...
    @RequirePermissions('owner.tenant.manage')
    async sendBroadcast(@Param('id') id: string, @Request() req: any, @Ip() ip: string) {
    ...
    async getSystemSettings() {
        return {
            ...
            maintenance: await this.systemConfigService.getAllByCategory('maintenance'),
        };
    }
    ...
    async updateSystemSetting(
        ...
        return this.systemConfigService.set(body.key, body.value, body.category, req.user.id, ip);
    }
    ...
    async updateTenantPlan(
        ...
        return this.ownerService.updateTenantPlan(tenantId, planKey, req.user.id, ip);
    }
    ...
    async impersonateTenant(
        ...
        return this.ownerService.generateImpersonationToken(tenantId, req.user.id, ip);
    }
