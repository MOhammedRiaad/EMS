...
import type { Alert, AlertSeverity, AlertCategory } from '../services/alerts.service';
...
export class AlertsController {
    ...
    @ApiQuery({ name: 'category', required: false, enum: ['usage', 'system', 'billing', 'security'] })
    ...
    async acknowledgeAllAlerts(
        @Body() filters: { severity?: AlertSeverity; category?: AlertCategory; tenantId?: string },
        @Request() req: any,
    ) {
