...
describe('AnalyticsService', () => {
    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: getRepositoryToken(ClientPackage), useFactory: mockRepository },
                ...
                { provide: getRepositoryToken(WaitingListEntry), useFactory: mockRepository },
                { provide: getRepositoryToken(ClientSessionReview), useFactory: mockRepository },
        ...
        clientPackageRepo = module.get<Repository<ClientPackage>>(getRepositoryToken(ClientPackage));
    });
    ...
    describe('getLeadAnalytics', () => {
        it('should return lead stats filtered by tenant', async () => {
            ...
            jest.spyOn(leadRepo, 'createQueryBuilder').mockReturnValue(mockQueryBuilder as any);
            ...
            expect(leadRepo.count).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('getRevenueForecast', () => {
        it('should calculate linear regression correctly', async () => {
            ...
            jest.spyOn(clientPackageRepo, 'createQueryBuilder').mockReturnValue(mockQueryBuilder as any);
            ...
            expect(mockQueryBuilder.where).toHaveBeenCalledWith('cp.tenantId = :tenantId', { tenantId });
        });
        ...
        it('should handle insufficient data gracefully', async () => {
            ...
            const mockQueryBuilder = {
                ...
                groupBy: jest.fn().mockReturnThis(),
                orderBy: jest.fn().mockReturnThis(),
                getRawMany: jest.fn().mockResolvedValue([{ period: '2023-01', revenue: '1000' }]), // Only 1 point
            };
