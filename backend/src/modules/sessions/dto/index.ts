...
export class CreateSessionDto {
  ...
  @ApiPropertyOptional({
    enum: ['daily', 'weekly', 'biweekly', 'monthly', 'variable'],
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: [1, 4],
    description: 'Days of week for recurrence (0=Sun, 1=Mon, ..., 6=Sat)',
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Slots for variable recurrence',
  })
  @IsOptional()
  @IsArray()
...
export class UpdateSessionStatusDto {
  ...
  @ApiPropertyOptional({
    description:
      'Whether to deduct a session from client package (for cancelled/no_show)',
  })
  @IsOptional()
