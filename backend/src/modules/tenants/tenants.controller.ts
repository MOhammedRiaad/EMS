import { Controller, Get, Patch, Param, Query, Body, UseGuards, Request, ForbiddenException } from '@nestjs/common';
...
export class TenantsController {
    ...
    @ApiQuery({ name: 'name', required: true, description: 'Business name to check' })
