...
export class CoachPortalController {
  ...
  getSchedule(
    ...
    return this.coachPortalService.getSchedule(
      req.user.id,
      tenantId,
      date,
      range,
  ...
  updateSessionStatus(
    ...
    return this.coachPortalService.updateSessionStatus(
      sessionId,
      req.user.id,
      tenantId,
  ...
  async getClientDetails(
    ...
    const hasAccess = await this.coachPortalService.checkClientAccess(
      req.user.id,
      clientId,
    );
    if (!hasAccess) {
  ...
  createTimeOffRequest(
    ...
    return this.coachPortalService.createTimeOffRequest(
      req.user.id,
      tenantId,
      dto,
    );
