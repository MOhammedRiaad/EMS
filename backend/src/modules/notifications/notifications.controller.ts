...
export class NotificationsController {
  ...
  getUserNotifications(@TenantId() tenantId: string, @Request() req: any) {
  ...
  getUnreadCount(@TenantId() tenantId: string, @Request() req: any) {
  ...
  markAllAsRead(@TenantId() tenantId: string, @Request() req: any) {
  ...
  getActiveAnnouncements(@TenantId() tenantId: string, @Request() req: any) {
    return this.notificationsService.getActiveAnnouncementsForUser(
      req.user.id,
      tenantId,
      req.user.role,
    );
  ...
  markAnnouncementRead(@Request() req: any, @Param('id') id: string) {
  ...
  deleteAnnouncement(@TenantId() tenantId: string, @Param('id') id: string) {
