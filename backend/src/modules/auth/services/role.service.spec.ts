...
describe('RoleService', () => {
    ...
    describe('getRoleById', () => {
        ...
        it('should throw NotFoundException if role not found', async () => {
            ...
            await expect(service.getRoleById('missing')).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('createRole', () => {
        ...
        it('should create a role and assign permissions by keys', async () => {
            ...
            expect(roleRepo.findOne).toHaveBeenCalledWith({ where: { key: 'new_role' } });
    ...
    describe('deleteRole', () => {
        ...
        it('should throw ConflictException when trying to delete system role', async () => {
            ...
            await expect(service.deleteRole('r-sys')).rejects.toThrow(ConflictException);
        });
    });
