    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createTable(new Table({
            ...
            columns: [
                ...
                { name: "payment_method", type: "varchar", length: "20", isNullable: true },
        ...
        await queryRunner.createForeignKey("client_packages", new TableForeignKey({
            columnNames: ["tenant_id"],
            referencedColumnNames: ["id"],
            referencedTableName: "tenants",
            onDelete: "CASCADE",
        ...
        await queryRunner.createTable(new Table({
            ...
            columns: [
                ...
                { name: "running_balance", type: "decimal", precision: 10, scale: 2, isNullable: true },
