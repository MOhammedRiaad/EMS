    ...
    return (
        <div className="p-6 space-y-8 pb-24 max-w-lg mx-auto md:max-w-4xl">
            <header>
                ...
                <p className="text-gray-500 text-sm mt-1">Track your body composition journey</p>
            </header>
            ...
            {latestScan && (
                <div className="grid grid-cols-3 gap-4">
                    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 text-center">
                        <div className="text-xs text-gray-500 font-semibold uppercase mb-1">Weight</div>
                        <div className="text-xl font-bold text-gray-900">{latestScan.weight} <span className="text-xs font-normal text-gray-400">kg</span></div>
                    </div>
                    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 text-center">
                        <div className="text-xs text-gray-500 font-semibold uppercase mb-1">Muscle</div>
                        <div className="text-xl font-bold text-blue-600">{latestScan.skeletalMuscleMass} <span className="text-xs font-normal text-gray-400">kg</span></div>
                    </div>
                    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 text-center">
                        <div className="text-xs text-gray-500 font-semibold uppercase mb-1">Body Fat</div>
                        <div className="text-xl font-bold text-orange-500">{latestScan.bodyFatPercentage} <span className="text-xs font-normal text-gray-400">%</span></div>
                    </div>
                </div>
            )}
            ...
            {scans.length > 0 ? (
                <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                    <h3 className="font-semibold text-gray-800 mb-4">Trends</h3>
