...
const CoachLayout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-900 font-sans pb-20">
            ...
            {!isSubPage && (
                <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-3 flex justify-around items-center z-50 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
