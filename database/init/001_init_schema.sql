...
CREATE TABLE clients (
    ...
    SET NULL,
        studio_id UUID REFERENCES studios(id) ON DELETE
    SET NULL,
...
CREATE TABLE sessions (
    ...
    ems_device_id UUID REFERENCES ems_devices(id) ON DELETE
    SET NULL,
        start_time TIMESTAMP WITH TIME ZONE NOT NULL,
        end_time TIMESTAMP WITH TIME ZONE NOT NULL,
        program_type VARCHAR(100),
        intensity_level INT CHECK (
            intensity_level BETWEEN 1 AND 10
        ),
...
-- Scheduling queries
CREATE INDEX idx_sessions_scheduling ON sessions(studio_id, start_time, end_time)
WHERE status != 'cancelled';
CREATE INDEX idx_sessions_room ON sessions(room_id, start_time, end_time)
WHERE status != 'cancelled';
CREATE INDEX idx_sessions_coach ON sessions(coach_id, start_time, end_time)
WHERE status != 'cancelled';
CREATE INDEX idx_sessions_client ON sessions(client_id, start_time);
CREATE INDEX idx_sessions_device ON sessions(ems_device_id, start_time, end_time)
WHERE status != 'cancelled'
    AND ems_device_id IS NOT NULL;
-- User lookups
...
CREATE TRIGGER update_studios_updated_at BEFORE
UPDATE ON studios FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- =============================================================================
-- Demo tenant
INSERT INTO tenants (id, name, slug, plan, features)
VALUES (
        '00000000-0000-0000-0000-000000000001',
        'Demo Studio Group',
        'demo',
        'professional',
        '{"multi_room": true, "reviews": true, "inbody": true}'
    );
-- Demo studio
INSERT INTO studios (
        id,
...
-- Demo rooms
INSERT INTO rooms (tenant_id, studio_id, name, capacity)
VALUES (
        '00000000-0000-0000-0000-000000000001',
        '00000000-0000-0000-0000-000000000002',
        'Room A',
...
VALUES (
        ...
        '00000000-0000-0000-0000-000000000001',
        'admin@demo.ems',
        '$2b$10$8Ux8KlKEhL5HDHQqLKJsouQKqJKqJKqJKqJKqJKqJKqJKqJKqJKqJ',
        'admin',
        'Demo',
        'Admin',
        true
